...
const SelectTriggerButton = ({
  ...
  <Listbox.Button className="SelectTrigger relative w-full cursor-default rounded-md border border-grey-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus-visible:border-indigo-500 focus-visible:ring-1 focus-visible:ring-indigo-500 sm:text-sm">
