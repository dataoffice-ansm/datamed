...
import LandingIllustrationSearch from '../../icons/landing_illustration_search.svg';
  ...
  return (
    <FullWidthRow className="bg-blue-20 shadow-inner">
      <div className="pt-32 pb-32 flex justify-center items-center lg:items-start flex-col-reverse lg:flex-row gap-16">
        <Image src={LandingIllustrationSearch} alt="Illustration de microscope et analyse" />
